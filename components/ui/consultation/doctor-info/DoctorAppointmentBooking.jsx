...
const SlotBox = ({ children }) => {
  return (
    <div className="bg-primary-100 text-white px-2 py-1 my-1 mx-1 rounded-md">
      {children}
    </div>
  );
};
...
const DoctorAppointmentBooking = () => {
  return (
    <div className="my-4">
      <div className="text-white font-semibold rounded-t p-2 bg-primary-100">
      ...
      <div className="border border-gray-300 border-t-0 w-full">
        <div className="flex pt-2 justify-between border-b border-gray-300">
          <div>
            ...
            <div className="w-full h-1 bg-primary-100"></div>
          </div>
          <div>
